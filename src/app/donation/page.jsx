        ...
        <div>
          ...
          <div>
            <div className="">
              ...
              >
                <SelectItem value="TRC20" key='TRC20' onClick={() => setSelectedOption('TRC20')} >
                  TRC20
                </SelectItem>
                <SelectItem value="BEP20" onClick={() => setSelectedOption('BEP20')}>
                  BEP20, Polygon
                </SelectItem>
              </Select>
              ...
              {/* { cryptoCode && ( */}
                ...
                <Image src={`https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=${cryptoCode}`} alt='qr' width={150} height={150} className='mx-auto rounded-lg'/>
              </div>
              <input type="text" id='crypto-code' value={cryptoCode} className='block w-full py-2 px-3 bg-[#27272A] text-gray-300 rounded-lg mt-4 h-12' readOnly/>
                </div>
              {/* )} */}
