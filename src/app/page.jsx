...
export default function Home() {
  ...
  return (
    <div className='app flex items-center justify-center h-screen'>
     <div className='flex justify-center items-center my-auto'>
      <div className="w-full max-w-xs">
        <Image src="/ooink_logo.svg" alt="Imagen SVG" width={200} height={0} className="mx-auto mb-8 pointer-events-none"/>
        <div className="flex justify-center items-center mb-4">
          ...
          <button onClick={() => getLink()} className="bg-ooink rounded-r-lg py-4 px-4 text-white" style={{padding: loading ? '0.5rem 0': '1rem'}}>
          {loading ? <Button
      isLoading
      color="#FF78A9"
      spinner={
    ...
    >
    </Button> : <Image src="/search.svg" alt='search' width={24.077} height={0} style={{minWidth: '24.077px'}}/>}
          </button>
        </div>
