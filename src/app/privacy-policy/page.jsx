            ...
            <div className="privacy-square">
              <div className="square-content">
                ...
                <p className="square-p">
                  ...
                  information. Personal information is not collected during the
                  conversion process.
                </p>

                <h2 className="square-title">Responsibility for Use</h2>
                <p className="square-p">
                  We understand that Ooink users may convert links to codes for
                  various purposes. We are not responsible for how users utilize
                  the codes generated through our service. We do not endorse or
                  guarantee the legality or suitability of any content accessed
                  through the generated codes.
                </p>

                <h2 className="square-title">Contact</h2>
                <p className="square-p">
                  If you have any questions or concerns related to the operation
